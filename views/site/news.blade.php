...
@section('content')
    <div class="wrapper">
        <div class="banner_c">
            <img src="{{yStatic('img/banner2.jpg')}}" class="banner_pic"/>
            <div class="banner_text">
                <img src="{{yStatic('img/banner_text2.png')}}"/>
            </div>
        </div>
            ...
            <div class="wrap">
                <ul class="news_list">
                    <li v-for="item in news">
                        <a v-bind:href="'/site/ndetail?id='+item.id">
                ...
                <div class="news_pagination">
                    <div>
                        <img src="{{yStatic('img/prev.png')}}" class="prev"/>
                        <ul class="num">
                            <li v-for="p in news_page" v-bind:class="{'active':p==query.page}">@{{ p }}</li>
                        </ul>
                        <img src="{{yStatic('img/next.png')}}" class="next"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- 员工动态 -->
        <div class="banner_c">
            <img src="{{yStatic('img/news_bg.jpg')}}" class="banner_pic"/>
            <div class="banner_text" style="top: 0;">
                <img src="{{yStatic('img/news_bg_text.png')}}" style="width: 45.8854%; margin-top: 12.1vw;"/>
            </div>
        </div>
        ...
        <div class="news_conn2">
            <div class="wrap">
                ...
                <img src="{{yStatic('img/prev.png')}}" class="employ_prev"/>
                <img src="{{yStatic('img/next.png')}}" class="employ_next"/>
            </div>
        </div>
        ...
        <div class="pic_toast">
            ...
            <div class="pic_wrap">
                <img src="{{yStatic('img/btn_close.png')}}" alt="关闭" class="btn_close"/>
                <img src="{{yStatic('img/employ1.jpg')}}" alt="" class="pic"/>
            </div>
        </div>
        <!-- /图片放大弹窗 -->
    </div>
...
@section('foot-script')
    <script>
		...
		// vue 在IE里不支持简写
                getNews:function() {
                    let _this = this;
                    Helper.asynRequest('GET', '/api/news-list', _this.query, function (response) {
		...
		// vue 在IE里不支持简写
                getActive:function() {
                    let _this = this;
                    Helper.asynRequest('GET', '/api/active-list', {}, function (response) {
