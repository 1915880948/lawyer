...
@section('content')
    ...
    <div class="container page_news">
        <div class="top_pic_c">
            <img src="{{yStatic('wap/img/top_pic1.jpg')}}" class="top_pic" />
            <img src="{{yStatic('wap/img/title3.png')}}" alt="HME NEWS  新闻与故事" class="title"/>
        </div>
        ...
        <div class="page_con con2">
            <div class="employees_top">
                <img src="{{yStatic('wap/img/news_bg.jpg')}}" alt="" class="news_bg"/>
                <img src="{{yStatic('wap/img/title4.png')}}" alt="HME THE LIFE OF OUR EMPLOYEES  员工动态" class="title"/>
            </div>
