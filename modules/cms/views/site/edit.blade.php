    ...
    <div class="login-container" id="loginContent">
        <el-form class="card-box login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm"
            ...
            <el-form-item >
                ...
                <a href="{{yUrl('/cms/site/login')}}" style="color: red; float: right; text-decoration: underline;"> >>>去登录</a>
            </el-form-item>
        </el-form>
    </div>
@stop
            ...
            methods: {
                ...
                handleEdit:function() {
                    ...
                    this.$refs.loginForm.validate(function(valid) {
                        if (valid) {
                            Helper.asynRequest('POST', '/cms/site/edit', _this.loginForm, function (response) {
