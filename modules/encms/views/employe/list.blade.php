    ...
    new Vue({
        ...
        methods: {
            ...
            handleEdit: function (index, row) {
                let _this = this;
                Helper.asynRequest('GET', '/encms/employe/detail', {id:row.id}, function (response) {
            ...
            handleOpreate: function (method,index, row,value) {
                ...
                _this.$confirm('您确定执行此操作吗, 是否继续?', '提示', {
                    ...
                    Helper.asynRequest('POST', '/encms/employe/operate', {method:method,id: row.id,value:value}, function (response) {
                        _this.$message({
                            type: 'success',
                            message: '操作成功!'
                        });
            ...
            request: function () {
                let _this = this;
                Helper.asynRequest('GET', '/encms/employe/list', _this.query, function (response) {
