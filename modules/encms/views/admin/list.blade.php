    ...
    <script>
        new Vue({
            ...
            methods: {
                ...
                onSubmit: function () {
                    let url = this.form.id ? '/encms/admin/edit' : '/encms/admin/create';
                    let _this =this;
                ...
                request: function () {
                    let _this = this;
                    Helper.asynRequest('GET', '/encms/admin/list', _this.query, function (response) {
