    ...
    <div class="login-container" id="loginContent">
        <el-form class="card-box login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm"
            ...
            <el-form-item>
                ...
                <a href="{{yUrl('/encms/site/edit')}}" style="color: red; float: right; text-decoration: underline;"> >>>修改密码</a>
            </el-form-item>
        </el-form>
    </div>
@stop
            ...
            methods: {
                ...
                handleLogin:function() {
                    ...
                    this.$refs.loginForm.validate(function(valid) {
                        if (valid) {
                            Helper.asynRequest('POST', '/encms/admin/login', _this.loginForm, function (response) {
                                if( response.code === 200 ){
                                    _this.$message({
                                        ...
                                        duration: 1000,
                                        onClose: function () {
                                            location.href = '/encms/site/index';
                                        }
                                    })
