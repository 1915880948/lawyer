    ...
    new Vue({
        ...
        methods: {
            handleCreate: function () {
                this.form.id = this.form.title = this.form.img_url = this.form.desc = this.form.content = this.form.time = '';
                this.form.sort = 10;this.shelf_status =1;
            },
            handleEdit: function (index, row) {
                let _this = this;
                Helper.asynRequest('GET', '/encms/news/detail', {id:row.id}, function (response) {
                    ...
                    _this.form.time = response.data.time;
            ...
            handleOpreate: function (method,index, row,value) {
                ...
                _this.$confirm('您确定执行此操作吗, 是否继续?', '提示', {
                    ...
                    Helper.asynRequest('POST', '/encms/news/operate', {method:method,id: row.id,value:value}, function (response) {
                        _this.$message({
                            type: 'success',
                            message: '操作成功!'
                        });
            ...
            request: function () {
                let _this = this;
                Helper.asynRequest('GET', '/encms/news/list', _this.query, function (response) {
