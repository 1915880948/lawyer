        ...
        methods: {
            ...
            handleOpreate: function (method,index, row,value) {
                ...
                _this.$confirm('您确定执行此操作吗, 是否继续?', '提示', {
                    ...
                    Helper.asynRequest('POST', '/encms/active/operate', {method:method,id: row.id,value:value}, function (response) {
                        _this.$message({
                            type: 'success',
                            message: '操作成功!'
                        });
            ...
            request: function () {
                let _this = this;
                Helper.asynRequest('GET', '/encms/active/list', _this.query, function (response) {
